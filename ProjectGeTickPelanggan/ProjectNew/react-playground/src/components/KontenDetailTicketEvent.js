                        ...
                        <div className='choiseTicket'>
                            <div className='choiseTicketKonten'>
                                ...
                                <span className='mainJumlahTicket'>
                                    Rp 400.000
                                    <button>
                                        <img className='jumlahTicket' src={Kurang}></img>
                                    </button>
                                    <input value="0" type="text" readOnly></input>
                                    <button>
                                        <img className='jumlahTicket' src={TambahBiru}></img>
                                    </button>
                                </span>
                                <div className='duoButtonDetailTicket'>
                                    <button onClick={halamanUtamaLogin}  className='ButtonKembaliDetailTicket'>Kembali</button>
                                    <button className='ButtonPesanDetailTicket' onClick={DetailPemesanan}>Pesan</button>
                                </div>
                            </div>
                        </div>
                    </div>
